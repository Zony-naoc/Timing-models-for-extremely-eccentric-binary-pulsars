...
{
    int p;
    const char *CVS_verNum = "$Id: 1515d8e9d73456a46286fc6a1ee8e4dacd1b0176 $";
...
//    strcpy(psr->param[param_ZERO].shortlabel[0],"Zero Offset");
    ...
    //DDE
    strcpy(psr->param[param_zeta1].label[0],"ZETA1"); 
    strcpy(psr->param[param_zeta1].shortlabel[0],"ZETA1"); 
    strcpy(psr->param[param_zeta2].label[0],"ZETA2"); 
    strcpy(psr->param[param_zeta2].shortlabel[0],"ZETA2"); 
    strcpy(psr->param[param_zeta3].label[0],"ZETA3"); 
    strcpy(psr->param[param_zeta3].shortlabel[0],"ZETA3"); 
    //...
